...
<html>
  <head>
	  <%@include file="head.jsp"%><%--静态导入某一片段--%>
	  <style type="text/css">
...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="${ctx}/Public/images/ego_logo.png" width="40" height="30">&nbsp;&nbsp;<b>ego</b></span>
      </a>
	      ...
	      <li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<li onclick="makecss(this)" data-id="categoryList_Goods">
	            		<a href='${ctx}/product/category/list' target='rightContent'><i class="fa fa-circle-o"></i>商品分类</a>
	            	</li><li onclick="makecss(this)" data-id="goodsList_Goods">
	            		<a href='${ctx}/product/list' target='rightContent'><i class="fa fa-circle-o"></i>商品列表</a>
...
<script src="${ctx}/Public/js/jquery-ui.min.js" type="text/javascript"></script>
<script src="${ctx}/Public/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${ctx}/Public/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="${ctx}/Public/plugins/fastclick/fastclick.min.js" type="text/javascript"></script>
<script src="${ctx}/Public/dist/js/app.js" type="text/javascript"></script>
<script src="${ctx}/Public/dist/js/demo.js" type="text/javascript"></script>
