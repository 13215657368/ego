...
<div id="doc">
    <div id="s_hdw">
        ...
        <div class="mmenu">
            <div class="s_hd">
                ...
                <div id="s_cart">
                    <ul>
                        <li class="nums"><a href="javascript:void(0);" id="s_cart_nums1">购物车： <span>0</span> 件</a> <a
                                href="" class="btn" id="s_cart_nums2"></a></li>
    ...
    <div id="s_bdw">
        <div id="s_bd">
            ...
            <div class="stepflow"><img src="${ctx}/images/stepend.gif" width="980" height="33" alt=""/></div>

            <form id="payForm" action="${ctx}/order/pay" method="post">
                ...
                <div class="osuccess">
                    ...
                    <div class="ddinfo">
                        订单编号：1011757885 <a class="blue" href="#">查看订单详情</a><br/>付款方式：在线支持 支付宝<br/>应付金额：<strong
                            class="red">￥${totalPrice}</strong>
                    </div>
                    <p class="gopay">
                        <a href="javascript:void(0);">
                            <img id="payId" onclick="pay();" src="${ctx}/images/gopay.gif" width="88" height="36" alt=""/>
                        </a>
                    </p>
