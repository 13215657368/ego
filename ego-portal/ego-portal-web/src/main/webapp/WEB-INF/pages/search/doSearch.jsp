...
<div id="doc">
    <div id="s_hdw">
        ...
        <div class="mmenu">
            <div class="s_hd">
                <div id="s_search">
                    <input id="searchStr" name="searchStr" value="${searchStr}" type="text" class="search-input"/>
                    <input id="searchImg" type="image" src="${ctx}/images/btn_search.jpg"/>
                </div>
        ...
        <div id="s_bd">
            ...
            <div class="f-r rightlist">
                ...
                <div class="productlist">
                    <ul id="goodsContent">
                        <%--<li>--%>
                        <%--<a href="#"><img src="${ctx}/images/21asfa.jpg" width="170" height="160" alt=""/></a>--%>
                        <%--<dl>--%>
                        <%--<dt><a href="#">凌仕魅动男士香氛-契合</a></dt>--%>
                        <%--<dd>特价：<strong class="red">￥52.9</strong></dd>--%>
                        <%--<dd><span class="startotal"></span></dd>--%>
                ...
                <div class="pagecon" id="pageContent">
                    <%--<div class="f-r pagination">--%>
                    <%--<span class="disabled">&lt; 上一页</span><span class="current">1</span><a href="#?page=2">2</a><a--%>
                    <%--href="#?page=3">3</a><a href="#?page=4">4</a><a href="#?page=5">5</a><a--%>
                    <%--href="#?page=6">6</a><a href="#?page=7">7</a><span class="dian3">...</span><a--%>
                    <%--href="#?page=199">199</a><a href="#?page=200">200</a><a href="#?page=2">下一页 &gt; </a>--%>
                    <%--<div class="yepage">到第<input class="stext" type="text" name="" id="" value="1"/>页<input--%>
...
<script type="template" id="goodsTemp">
    ...
    <li>
        ...
        <dl>
            <dt><a href="#">{{=it[i].goodsHlName}}</a></dt>
            <dd>特价：<strong class="red">￥{{=it[i].marketPrice}}</strong></dd>
            <dd><span class="startotal"></span></dd>
            <dd><a class="addcat" href="javascript:void(0);"
                   onclick="addToCart('{{=it[i].goodsId}}', '{{=it[i].goodsName}}', '{{=it[i].marketPrice}}', '{{=it[i].originalImg}}');">加入购物车</a></dd>
        </dl>
    </li>
    {{ } }}
</script>
<script type="template" id="pageTemp">
    <div class="f-r pagination">
        {{ if(it.hasPre){ }}
        <a href="javascript:void(0);" onclick="doSearch('{{=it.currentPage-1}}');">&lt; 上一页</a>
        {{ } }}
        ...
        {{ if(it.hasNext){ }}
        <a href="javascript:void(0);" onclick="doSearch('{{=it.currentPage+1}}');">下一页 &gt; </a>
        {{ } }}
        <div class="yepage">
            到第<input class="stext" type="text" id="pageBtn" value="1"/>页
            <input class="btnimg" type="submit" value="" onclick="doSearch();"/>
        </div>
    </div>
</script>
<script type="text/javascript">
    ...
    // 搜索商品
    function doSearch(pageNum=1, pageSize=12) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.result.length > 0) {
                    ...
                    $("#goodsContent").html(goodsTemp(result.result));

                    // 调用模板
                    var pageTemp = doT.template($("#pageTemp").text());
                    $("#pageContent").html(pageTemp(result));
                } else {
